...
- V přiloženém archivu ale najdete sadu testovacích souborů v UTF8 (přípona .utf8) a jim odpovídajících ekvivalentů ve Fibonacciho kódu (přípona .fib). Testovací sada obsahuje i neplatné soubory, pro takové chybí jejich ekvivalent ve druhém kódu.
